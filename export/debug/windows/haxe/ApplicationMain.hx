...
class ApplicationMain
{
	...
	public static function main()
	{
		...
		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("MyApplication", null, 320, 240);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["name"] = "Platformer Example Made with ChatGPT";
		app.meta["packageName"] = "com.kookerfoxyt.platformergptexample";
		...
		var attributes:lime.ui.WindowAttributes = {
			...
			parameters: {},
			resizable: true,
			title: "Platformer Example Made with ChatGPT",
			width: 320,
			x: null,
			y: null,
		};
